...
<body class="no-animsition">
						...
						<li class="language-nav-item">
							<div class="btn-group">
								...
								<ul class="dropdown-menu language-block" role="menu">
									...
									<li><a href="index.html.pl" class="language"><img src="static/images/flags/poland.png" alt="Polaco" class="img-thumbnail icon-medium"></a></li>
									<li><a href="index.html.ru" class="language"><img src="static/images/flags/russia.png" alt="Ruso" class="img-thumbnail icon-medium"></a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-md-6 col-md-push-6 text-center text-md-left order-md-2">
					<h3 class="m-b-30 open-sans-bold">¡Ha recibido dinero!</h3>
	...
	<section class="section section-about-1 bg-white why-us-main-block p-t-20" id="why">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-5 margin-left-7p">
					<h3 class="section-heading m-b-30 block2-title-margin-top open-sans-bold">Pagos inteligentes condicionales libres de riesgos</h3>
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<div class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse11" aria-expanded="false" aria-controls="collapse11">
								<i class="iconbox-icon"></i>
			...
			<div class="row">
				...
				<div class="col-md-5 margin-left-7p">
					<h3 class="section-heading m-b-30 block2-title-margin-top open-sans-bold">Seguro P2P</h3>
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<a class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse11" aria-expanded="false" aria-controls="collapse11">
								<i class="iconbox-icon"></i>
			...
			<div class="row">
				...
				<div class="col-md-5 margin-left-7p">
					<h3 class="section-heading m-b-30 block2-title-margin-top open-sans-bold">Mercados de predicción</h3>
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<a class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse11" aria-expanded="false" aria-controls="collapse11">
								<i class="iconbox-icon"></i>
			...
			<div class="row">
				...
				<div class="col-md-5 margin-left-7p">
					<h3 class="section-heading m-b-30 block2-title-margin-top open-sans-bold">Apuestas P2P</h3>
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<a class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse11" aria-expanded="false" aria-controls="collapse11">
								<i class="iconbox-icon"></i>
				...
				<div class="col-md-5 margin-left-7p">
					...
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						...
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<div class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse22" aria-expanded="false" aria-controls="collapse22">
								<i class="iconbox-icon" style="background: none !important;border: none !important;box-shadow: none !important;"></i>
								<span class="iconbox-text iconbox-text-100 open-sans-regular">The sender just writes an email address where he would normally write a Byteball address. El receptor hace clic en el enlace recibido por email o chat. Si el destinatario aún no está en Byteball, se le pedirá que instale el monedero. En Android, la instalación comienza automáticamente. <a href="https://medium.com/byteball/sending-cryptocurrency-to-email-5c9bce22b8a9" target="_blank">Learn more</a>.</span>
							</div>
						</li>
					</ul>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-5 margin-left-7p">
					<h3 class="section-heading m-b-30 block2-title-margin-top open-sans-bold">Identidad soberana</h3>
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<a class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse11" aria-expanded="false" aria-controls="collapse11">
								<i class="iconbox-icon"></i>
						...
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<div class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse22" aria-expanded="false" aria-controls="collapse22">
								<i class="iconbox-icon" style="background: none !important;border: none !important;box-shadow: none !important;"></i>
								<span class="iconbox-text iconbox-text-100 open-sans-regular">Have your real identity verified and securely stored in your wallet. <a href="https://www.jumio.com/" target="_blank">Jumio</a> facilita la verificación de ID. Cuando quiera revelar su identidad a un proveedor de servicios, p. ej. para participar en una ICO, puede obtenerlo de su monedero en unos pocos clicks. <a href="https://medium.com/byteball/bringing-identity-to-crypto-b35964feee8e" target="_blank">Learn more</a>.</span>
							</div>
						</li>
					</ul>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-5 margin-left-7p">
					<h3 class="section-heading m-b-30 block2-title-margin-top open-sans-bold">Pagos P2P integrados</h3>
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<a class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse11" aria-expanded="false" aria-controls="collapse11">
								<i class="iconbox-icon"></i>
			...
			<div class="row">
				...
				<div class="col-md-5 margin-left-7p">
					<h3 class="section-heading m-b-30 block2-title-margin-top open-sans-bold">Moneda no rastreable: Blackbytes</h3>
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<a class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse11" aria-expanded="false" aria-controls="collapse11">
								<i class="iconbox-icon"></i>
			...
			<div class="row">
				...
				<div class="col-md-5 margin-left-7p">
					<h3 class="section-heading m-b-30 block2-title-margin-top open-sans-bold">Cada usuario ayuda</h3>
					<ul class="v-list list-text-icon list-text-icon-accordion m-b-20" id="accordion" role="tablist" aria-multiselectable="true">
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text">
							<a class="iconbox-item-title collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse11" aria-expanded="false" aria-controls="collapse11">
								<i class="iconbox-icon"></i>
				...
				<div class="col-sm-12 col-xs-12 col-md-12 col-lg-5 features-col1">
					<ul class="v-list list-text-icon">
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text iconbox-style-2-with-text-lg iconbox-style-2-with-text-right wow fadeInLeft col1-feature" data-wow-duration="0.8s" data-wow-delay="0.2s">
							...
							<p class="collapse show iconbox-item-text source-sans-pro-regular">When two parties sign a single unit that executes both legs of the exchange, the two transactions either happen simultaneously or don't happen at all. Ya no es necesario confiar en intercambios centralizados.</p>
						</li>
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text iconbox-style-2-with-text-lg iconbox-style-2-with-text-right wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.4s">
							...
							<p class="collapse show iconbox-item-text source-sans-pro-regular">For security, you can require that your funds be spendable only when several signatures are provided, e.g. from your laptop and from your phone. Para control compartido de los fondos, firmas desde diferentes personas pueden ser necesarias.</p>
						</li>
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text iconbox-style-2-with-text-lg iconbox-style-2-with-text-right wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.6s">
							...
							<p class="collapse show iconbox-item-text source-sans-pro-regular">Una vez guardados en la base de datos de Byteball, los datos no pueden ser modificados ni borrados.</p>
						</li>
					</ul>
				</div>
				...
				<div class="col-sm-12 col-xs-12 col-md-12 col-lg-5">
					<ul class="v-list list-text-icon list-text-icon-invert">
						<li class="iconbox iconbox-style-2 iconbox-style-2-with-text iconbox-style-2-with-text-lg wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
							...
							<p class="collapse show iconbox-item-text source-sans-pro-regular">Entidades reguladas pueden emitir valores que cumplan los requisitos de KYC/AML. Every transfer of such asset is to be cosigned by the issuer, and if there is anything that contradicts the regulations, the issuer won't cosign.</p>
						</li>
			...
			<div class="row bg-gray-50">
				<div class="col-lg-12 distibution-desc-div-padding">
					...
					<p class="distribution-text2">
						-  <a href="https://medium.com/byteball/byteball-cashback-program-9c717b8d3173" target="_blank">Cashback</a> for purchases at the merchant stores we partner with. En la mayoría de los casos, la devolución de dinero ofrecida es el 10% del monto de la compra.
						...
						<br>-  <a href="https://medium.com/byteball-help/using-mailchimp-to-mass-send-payments-as-textcoins-5c1db06342e3" target="_blank">Mass sending of textcoins</a> to subscribers of our partners. Compruebe los <a href="https://docs.google.com/spreadsheets/d/1heT6TUSpTJgRW-FUM0LbcoVjXZRCb3PbXQQLmzvNRvM/edit#gid=323859176" target="_blank">resultados de las campañas anteriores</a>.                    </p>
				</div>
			</div>
			...
			<div class="row bg-gray-50">
				<div class="col-lg-12 distibution-desc-div-padding">
					<h3 class="m-b-40 distribution-text">
						En el pasado, también se distribuyeron Bytes a poseedores de BTC y Bytes. Los usuarios vinculaban sus direcciones BTC y Byteball y recibían nuevos Bytes en proporción de sus saldos existentes en BTC y Bytes. Esta distribución se dividió en varias rondas.
						<br><br>The first distribution round took place on Dec 25, 2016 when the network launched, over 70,000 BTC was linked, and 10% of the total supply of bytes and blackbytes was distributed. En las rondas posteriores, el total distribuido llegó a 64.5%:
					</h3>
					<p class="left-float col-lg-6 col-xs-12 m-b-10 distribution-text2">2° ronda el 11 de Febrero de 2017: 121.763 BTC vinculados, 1.8% distribuidos;</p>
					<p class="left-float col-lg-6 col-xs-12 m-b-10 distribution-text2">3° ronda el 12 de Marzo de 2017: 129.139 BTC vinculados, 2.0% distribuidos;</p>
					<p class="left-float col-lg-6 col-xs-12 m-b-10 distribution-text2">4° ronda el 11 de Abril de 2017: 145,441 BTC vinculados, 2.3% distribuidos;</p>
					<p class="left-float col-lg-6 col-xs-12 m-b-10 distribution-text2">5° ronda el 10 de Mayo de 2017: 207,672 BTC vinculados, 2.9% distribuidos;</p>
					<p class="left-float col-lg-6 col-xs-12 m-b-10 distribution-text2">6° ronda el 9 de Junio de 2017: 453,621 BTC vinculados, 6.6% distribuidos;</p>
					<p class="left-float col-lg-6 col-xs-12 m-b-10 distribution-text2">7° ronda el 9 de Julio de 2017: 949,004 BTC vinculados, 11.0% distribuidos.</p>
					<p class="left-float col-lg-6 col-xs-12 m-b-10 distribution-text2">8° ronda el 7 de Agosto de 2017: 1,395,899 BTC vinculados, 16.0% distribuidos.</p>
					<p class="left-float col-lg-6 col-xs-12 m-b-10 distribution-text2">9° ronda el 6 de Septiembre de 2017: 1,306,573 BTC vinculados, 5.7% distribuidos.</p>
					<p class="left-float col-lg-6 col-xs-12 m-b-10 distribution-text2">9° ronda el 4 de Noviembre de 2017: 1,093,155 BTC vinculados, 6.1% distribuidos.</p>
				</div>
			</div>
			...
			<div class="row bg-gray-50">
				<div class="col-lg-12 distibution-desc-div-padding">
					<p class="distribution-text3">
						...
						<br><br>
						Blockless design is simpler because there are no blocks, there are only transactions. Los usuarios sólo agregan sus transacciones al final del GAD, no tienen que esperar cuando los mineros crean un nuevo bloque y no hay conjeturas acerca de si los mineros incluirán su transacción en el bloque.
						<br>
	...
	<!-- Pricing Tables start-->
	<section class="section section-price-table" id="learn_more">
		<div class="container">
			<hr class="new-breaker-line">
			<div class="row justify-content-md-center">
				<div class="col-md-12">
					...
					<div class="section-heading--center m-t-80 m-b-40">
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 left-float m-b-40 community-item">
							<a href="https://github.com/byteball" target="_blank">
								<img data-img="github_img" src="static/images/github_img.png" style="max-width: 100%;">
							</a>
						</div>
			...
			<ul class="list-reset partner-list p-b-30">
				<li class="wow zoomIn col-lg-3 col-md-4 col-sm-6 col-xs-6 m-b-15 left-float" data-wow-duration="0.5s" data-wow-delay="0.2s">
					<div class="iconbox iconbox-style-4">
						<a class="iconbox-image" href="https://bittrex.com/Market/Index?MarketName=BTC-GBYTE" target="_blank">
							<img src="static/images/bittrex_img.png" alt="" />
						</a>
					</div>
				</li>
				<li class="wow zoomIn col-lg-3 col-md-4 col-sm-6 col-xs-6 m-b-15 left-float" data-wow-duration="0.5s" data-wow-delay="0.8s">
					<div class="iconbox iconbox-style-4">
						<a class="iconbox-image" href="https://upbit.com/exchange?code=CRIX.UPBIT.BTC-GBYTE" target="_blank">
							<img src="static/images/upbit_img.png"/>
						</a>
					</div>
				</li>
				<li class="wow zoomIn col-lg-3 col-md-4 col-sm-6 col-xs-6 m-b-15 left-float" data-wow-duration="0.5s" data-wow-delay="0.4s">
					<div class="iconbox iconbox-style-4">
						<a class="iconbox-image" href="https://cryptox.pl/" target="_blank">
							<img src="static/images/cryptox_img.png"/>
						</a>
					</div>
				</li>
				<li class="wow zoomIn col-lg-3 col-md-4 col-sm-6 col-xs-6 m-b-15 left-float" data-wow-duration="0.5s" data-wow-delay="0.6s">
					<div class="iconbox iconbox-style-4">
						<a class="iconbox-image" href="https://www.cryptopia.co.nz/Exchange/?market=GBYTE_BTC" target="_blank">
							<img src="static/images/cryptopia_img.png"/>
						</a>
					</div>
				</li>
				<li class="wow zoomIn col-lg-3 col-md-4 col-sm-6 col-xs-6 m-b-15 left-float" data-wow-duration="0.5s" data-wow-delay="0.2s">
					<div class="iconbox iconbox-style-4">
						<a class="iconbox-image" href="https://bisq.network" target="_blank">
							<img src="static/images/bisq_img.png"/>
						</a>
					</div>
				</li>
				<li class="wow zoomIn col-lg-3 col-md-4 col-sm-6 col-xs-6 m-b-15 left-float" data-wow-duration="0.5s" data-wow-delay="0.4s">
					<div class="iconbox iconbox-style-4">
						<a class="iconbox-image" href="https://www.kaiserex.com" target="_blank">
							<img src="static/images/kaiserex_img.png"/>
						</a>
					</div>
				</li>
				<li class="wow zoomIn col-lg-3 col-md-4 col-sm-6 col-xs-6 m-b-15 left-float" data-wow-duration="0.5s" data-wow-delay="0.6s">
					<div class="iconbox iconbox-style-4">
						<a class="iconbox-image" href="https://kkex.com" target="_blank">
							<img src="static/images/kkex_img.png"/>
						</a>
					</div>
				</li>
				<li class="wow zoomIn col-lg-3 col-md-4 col-sm-6 col-xs-6 m-b-15 left-float" data-wow-duration="0.5s" data-wow-delay="0.8s">
					<div class="iconbox iconbox-style-4">
						<a class="iconbox-image" href="https://indacoin.com/en_GB/change/buy-Bytes-with-cardusd" target="_blank">
							<img src="static/images/indacoin_img.png"/>
						</a>
					</div>
				</li>
			</ul>
	...
	<section class="section section-cta-1 pos-relative bg-parallax p-t-60 p-b-30" style="background-color: black !important;">
				<div class="container">
			<script type="text/javascript" src="https://static.mailerlite.com/data/webforms/884470/p2o8d6.js?v5"></script>
		</div>
	</section>
	<!-- Subcribe end-->
